...
For test conventions and the model-layout rule, see `services.instructions.md`. For the file tree and event-wiring narrative, see `docs/ARCHITECTURE.md`.
