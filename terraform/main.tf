...
resource "digitalocean_droplet" "bridge" {
...
# ---------------------------------------------------------------------------
resource "digitalocean_reserved_ip" "bridge" {
  region     = var.droplet_region
  droplet_id = digitalocean_droplet.bridge.id
}
...
resource "digitalocean_firewall" "bridge" {
  name        = "ibkr-bridge-fw"
  droplet_ids = [digitalocean_droplet.bridge.id]
